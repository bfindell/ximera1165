...
\node at (11, -1.25) {$420$};
\node at (11, 1.25) {$C$};
\foreach \x in {1, 3, 6, 7, 11} \draw (\x, -1.1)--(\x, -0.9); 
\foreach \y in {1, 3, 6, 7, 11} \draw (\y, 1.1)--(\y, 0.9);
\end{tikzpicture}
\end{center}
...
\begin{prompt}	
	...
	We also have $D = \answer[given]{3}$, $E = \answer[given]{315}$, and $F = \answer[given]{318}$.
