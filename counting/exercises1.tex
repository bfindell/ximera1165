...
\begin{prompt}
 $\answer{a^4}+\answer{4a^3b}+\answer{6a^2b^2}+\answer{4ab^3}+\answer{b^4}$. % Ximera CAS accepts $(a+b)^4$
\end{prompt}
\end{problem}
\end{problem}
...
\begin{prompt}
 $\answer{729}+\answer{1458x}+\answer{1215x^2}+\answer{540x^3}+\answer{135x^4}+\answer{18x^5}+\answer{x^6}$  % Ximera CAS accepts $(3-x)^6$
\end{prompt}
\end{problem}
\end{problem}
...
\begin{selectAll}
\choice[correct]{$x^2y^7$}
\choice{$x^5y^3$}
\choice[correct]{$x^4y^5$}
\choice{$x^9y$}
\choice[correct]{$y^9$}
\choice{$x^6$}
\choice[correct]{$xy^8$}
