...
When $n$ is a \wordChoice{\choice{real number} \choice{rational number} \choice{counting number} \choice{integer} }, $a^n$ means the $\answer[format=string]{product}$ of $\answer{n}$ (copies of) $\answer{a}$.
\end{problem}
\end{problem}
