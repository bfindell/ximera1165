...
Fill out the following table corresponding to the amount Trish deposits in her bank account $n$ weeks from now.
\[
\begin{array}{c|c} \hline
n & \text{Depoist Amount} \\ \hline
1 & \answer{25} \\
2 & \answer{27} \\
3 & \answer{29}\\
4 & \answer{31}\\
...
How much money does Trish deposit in her bank account after $52$ weeks have passed?
...
Write an expression for the amount of money Trish will deposit in her bank account $n$ weeks from now.

\begin{prompt}
Trish will deposit $\answer[given]{23+52n}$ in her bank account.
\end{prompt}
\end{problem}
