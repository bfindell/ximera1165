...
\begin{prompt}
Sylvie will deposit \wordChoice{\choice[correct]{Next} \choice{Now} \choice{$n$} \choice{400} \choice{1.1} \choice{0.1}} $=$ \wordChoice{\choice{Next} \choice[correct]{Now} \choice{$n$} \choice{400} \choice{1.1} \choice{0.1}}  $\times$  \wordChoice{\choice{Next} \choice{Now} \choice{$n$} \choice{400} \choice[correct]{1.1} \choice{0.1}}.
\end{prompt}
