...
\begin{enumerate}
\item $1$ Kilobyte (1 KB) $=  2^{10}\textrm{ bytes }\approx \answer{1000}$ bytes = one \wordChoice{\choice[correct]{thousand} \choice{million} \choice{billion} \choice{trillion}} bytes.
\item $1$ Megabyte (1 MB) $=  \answer{2^{20}} \textrm{ bytes } \approx \answer{1000^2}$ bytes = one \wordChoice{\choice{thousand} \choice[correct]{million} \choice{billion} \choice{trillion}} bytes.
\item $1$ Gigabyte (1 GB) $=  \answer{2^{30}} \textrm{ bytes } \approx \answer{1000^3}$ bytes = one \wordChoice{\choice{thousand} \choice{million} \choice[correct]{billion} \choice{trillion}} bytes.
\item $1$ Terabyte (1 TB) $=  \answer{2^{40}} \textrm{ bytes } \approx \answer{1000^4}$ bytes = one \wordChoice{\choice{thousand} \choice{million} \choice{billion} \choice[correct]{trillion}} bytes.
\end{enumerate}
...
\item Online speed: $\answer{100\cdot10^6/300}$. % [tolerance=.05*100*10^6/300]
\end{enumerate}
