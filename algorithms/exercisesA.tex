...
\begin{problem}
In beginning algebra, simplifying expressions often involves \textit{collecting like terms}.  But why does this work?  Well, the expression $3x+4x$ is equivalent to $(3+4)x$ by the \wordChoice{\choice{commutative}\choice{associative}\choice[correct]{distributive}} property.  And then it is clear that $(3+4)x = \answer{7x}$. 
\end{problem}
...
Now try applying the tax first.  The original price with tax would be $\$\answer{230}$.  Then with the discount, the cost would be $\$\answer{184}$, which is \wordChoice{\choice{greater than}\choice[correct]{equal to}\choice{less than}} the cost when applying the discount first.  

Will this work for any starting price?  We need to generalize.  

\begin{problem}
\textbf{Discount first.}
Suppose the starting price is $\$p$.  A $20\%$ discount, in terms of $p$, will be $\$\answer{0.2p}$.  So the price after the discount would $p - 0.2p$.  And by the \wordChoice{\choice{commutative}\choice{inverse}\choice[correct]{distributive}} property, this is equal to $(1-0.2)p$, or $\answer{0.8p}$.  In other words, rather than computing the discount and subtracting, we can directly compute the new price by multiplying the original price by $\answer{0.8}$.  This makes sense because with a discount of $20$ percent, the price we pay will be $\answer{80}$ percent of the original price.  
\begin{problem}
\textbf{Tax first.}
Again, suppose the starting price is $\$p$.  A $15\%$ tax, in terms of $p$, will be $\$\answer{0.15p}$.  So the price with tax would $p + 0.15p$.  And by the \wordChoice{\choice{commutative}\choice{identity}\choice[correct]{distributive}} property, this is equal to $\answer{1.15p}$.  In other words, rather than computing the tax and adding, we can directly compute the new price by multiplying the original price by $\answer{1.15}$.  This makes sense because with a tax of $15$ percent, the price we pay after tax will be $\answer{115}$ percent of the original price.  
\begin{problem}
...
These expressions are equal because of the \wordChoice{\choice{identity}choice[correct]{associative}\choice{distributive}} and \wordChoice{\choice[correct]{commutative}\choice{inverse}\choice{distributive}} properties of \wordChoice{\choice{addition}\choice{subtraction}\choice[correct]{multiplication}\choice{division}}.  Thus, the final cost is the same either way. 
\end{problem}
\end{problem} 
\end{problem}
\end{problem}
