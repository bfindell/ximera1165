...
\begin{problem}
Factor the following integers.  Enter the primes in increases order, use * for multiplication, and do not use exponents.  If the number is prime, enter the number itself.
\begin{enumerate}
\item $15\qquad$ $3*5$
\item $12\qquad$ $2*2*3$
