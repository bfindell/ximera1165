...
\item $7|41$  \wordChoice{\choice[correct]{True}\choice{False}}
...
\begin{hint} $6=2\cdot3$, $1000 = 2^3\cdot5^3$, and $6000 = 2^4\cdot3\cdot5^3$.  In each case, the primes appear enough times in the second number.\end{hint}
\end{enumerate}
\end{problem}
...
\item $\gcd(462,1463) = \answer{77}$  
  \begin{hint} $462 = 2\cdot 3\cdot 7\cdot 11$;  $1463 = 7\cdot 11\cdot 19$.\end{hint}
\item $\gcd(541,4669) = \answer{1}$. 
  \begin{hint}$541$ is prime.  $4669 = 7\cdot 23\cdot 29$\end{hint}
...
\begin{freeResponse}
\begin{hint}
The answer ``$2 \text{ remainder }4$'' is not a single number but rather a pair of numbers that play different roles.  Calling this pair of numbers ``equal'' is questionable.  Furthermore, in the division problems, the 2 is about different things: groups of 8 versus groups of 12.  
\end{hint}
\end{freeResponse}
