...
\choice{3 real solutions}
\choice{4 real solutions}
\choice[correct]{1 real solution and 2 imaginary solutions}
\choice{2 (distinct) real solutions and 2 imaginary solutions}
\choice{1 (double) real solution and 2 imaginary solutions}
\end{multipleChoice}
\begin{problem}
...
\choice{3 real solutions}
\choice{4 real solutions}
\choice{1 real solution and 2 imaginary solutions}
\choice{2 (distinct) real solutions and 2 imaginary solutions}
\choice[correct]{1 (double) real solution and 2 imaginary solutions}
\end{multipleChoice}
\begin{problem}
Enter first the real solution then the imaginary solutions (as a conjugate pair).
